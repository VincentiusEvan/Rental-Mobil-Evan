  ...
  <div class="container-fluid h-custom">
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      <form method="post" action="koneksi/proses.php?id=login">
                        ...
                        <input type="text" name="user" id="" class="form-control" placeholder="admin" aria-describedby="helpId">
                        </div>
                        <div class="form-group">
                        <label for="">Password</label>
                        <input type="password" name="pass" id="" class="form-control" placeholder="admin" aria-describedby="helpId">
                        </div>
                        <br>
                        <center><button class="btn btn-primary">Login</button>
                        
                        <a href="daftar.php" class="btn btn-danger" >Daftar</a></center>
                    </form>
          </div>
      </div>
    </div>
